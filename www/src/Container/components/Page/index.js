  ...
  render() {
    ...
    return (
      <div className="page">
        ...
        />
        <p className="copy-right disable-select"><span role="img" aria-label="emoji">💪</span> Last released on July 1st.<br/>I constantly update this site to keep you impressed.</p>
