  ...
  render() {
    ...
    return (
      <div className="page">
        ...
        />
        <p className="copy-right disable-select"><span role="img" aria-label="emoji">💪</span> Last released on July 4th.<br/>I constantly update this site to keep you impressed.</p>
